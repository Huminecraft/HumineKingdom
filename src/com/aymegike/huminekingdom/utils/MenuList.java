...
public class MenuList {
	...
	public static Menu rankedMenu(Player player) {		
		...
		Menu menu = new Menu(player, ChatColor.DARK_PURPLE+"- "+ChatColor.WHITE+"Classment"+ChatColor.DARK_PURPLE+" -", 3*9, false);
		...
		ItemMeta ironm = gold.getItemMeta();
		...
		if (firstKing != null) {
			first = new ItemStack(Material.LEGACY_SKULL_ITEM, 1, (byte) SkullType.PLAYER.ordinal());
			SkullMeta firstm = (SkullMeta) first.getItemMeta();
			firstm.setDisplayName(ChatColor.GREEN+HumineKingdom.getPlayerKingdom(firstKing).getName());
			firstm.setOwningPlayer(firstKing);
			lore.add(ChatColor.DARK_PURPLE+"Roi: "+ChatColor.WHITE+firstKing.getName());
			lore.add(ChatColor.DARK_PURPLE+"Gloire: "+ChatColor.WHITE+HumineKingdom.getPlayerKingdom(firstKing).getGlory());
			firstm.setLore(lore);
		...
		for (Kingdom kingdom : HumineKingdom.getKingdomManager().getKingdomList()) {
			if (kingdom.getGlory() > secondMaxPoint && kingdom.getGlory() <= maxPoint && !kingdom.getKing().getName().equalsIgnoreCase(firstKing.getName())) {
		...
		if (secondKing != null) {
			second = new ItemStack(Material.LEGACY_SKULL_ITEM, 1, (byte) SkullType.PLAYER.ordinal());
			SkullMeta secondm = (SkullMeta) second.getItemMeta();
			secondm.setDisplayName(ChatColor.GREEN+HumineKingdom.getPlayerKingdom(secondKing).getName());
			secondm.setOwningPlayer(secondKing);
			lore.add(ChatColor.DARK_PURPLE+"Roi: "+ChatColor.WHITE+secondKing.getName());
			lore.add(ChatColor.DARK_PURPLE+"Gloire: "+ChatColor.WHITE+HumineKingdom.getPlayerKingdom(secondKing).getGlory());
		...
		if (threeKing != null) {
			three = new ItemStack(Material.LEGACY_SKULL_ITEM, 1, (byte) SkullType.PLAYER.ordinal());
			SkullMeta threem = (SkullMeta) three.getItemMeta();
			threem.setDisplayName(ChatColor.GREEN+HumineKingdom.getPlayerKingdom(threeKing).getName());
		...
		ItemStack noBody = new ItemStack(Material.LEGACY_SKULL_ITEM, 1, (byte) SkullType.PLAYER.ordinal());
		...
		menu.setItem(10, (first != null) ? first : noBody);
		menu.setItem(13, (second != null) ? second : noBody);
		menu.setItem(16, (three != null) ? three : noBody);
		
			
		menu.setItem(9, diamond);
		menu.setItem(11, diamond);
		menu.setItem(12, gold);
		menu.setItem(14, gold);
		menu.setItem(15, iron);
		menu.setItem(17, iron);
